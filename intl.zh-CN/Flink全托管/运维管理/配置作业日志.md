...
-   Flink UI无法打开，需要查看Job Manager日志定位问题。
    ...
    **说明：**
    ...
    -   如果因为Job Manager和Task Manger都没有正常启动，导致您在OSS上没有找到对应的日志文件，请[提交工单](https://account.alibabacloud.com/login/login.htm?oauth_callback=https%3A//ticket-intl.console.aliyun.com/%23)。
